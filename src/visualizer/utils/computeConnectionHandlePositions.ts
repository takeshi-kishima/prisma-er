import { Position } from "@/visualizer/types/positions";
...
export const computeConnectionHandlePos = ({ sourceX, sourceW, targetW, targetX }: Params): [Position, Position, number, number] => {
