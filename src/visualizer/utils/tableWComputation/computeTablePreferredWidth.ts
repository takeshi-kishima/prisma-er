...
export const computeTablePreferredWidth = (tableTexts: string[], tableName: string): number => {
  ...
  return Math.max(maxOnColsAndTableName + TABLE_FIELD_TYPE_PADDING * 2, TABLE_DEFAULT_MIN_WIDTH);
};
