...
export const COLS_OFFSET_Y_TO_COL_MIDDLE =
  TABLE_COLOR_HEIGHT + COLUMN_HEIGHT + COLUMN_HEIGHT / 2;
export const CONNECTION_HANDLE_OFFSET = 20;
export const PADDINGS = { xs: 5, sm: 8, md: 10, lg: 20 };
export const TABLE_FIELD_TYPE_PADDING = PADDINGS.sm;
export const FONT_SIZES = { md: 15, lg: 18, tableTitle: 18 };
export const FIELD_DETAILS_CARET = { w: 5, h: 5 };
